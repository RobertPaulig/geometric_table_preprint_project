...
which of those will die later by a deeper horizon $Q_{\mathrm{horizon}}$. The goal is not to reject
cheap trash, but to prioritize additional factoring to avoid expensive PRP/LL on doomed survivors.
...
(not literal PrimeNet TF bits). We report bootstrap CI and permutation sanity; in this run enrichment is generally close to baseline
and CI often crosses 1, suggesting a weak/unstable proxy signal at this scale.
