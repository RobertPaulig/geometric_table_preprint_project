...
\begin{figure}[h]
\centering
\includegraphics[width=0.95\linewidth]{../out/wave_atlas/m34/m34_preview_grid.png}
\caption{Overlay preview grid: real vs permute-columns sanity across $n_{\mathrm{start}}$ (M34). See MP4 files in \texttt{out/wave\_atlas/m34/}.}
\end{figure}
