...
\begin{table}[h]
\centering
\input{out/latex_table_groups_six_ones_core.tex}
\caption{Group statistics for six-only batch (weight: ones, core-only).}
\end{table}

\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{fig/core_gap_box_twins_six_ones_core.png}
\caption{Six-only: core GC gap (twins vs non-twins).}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{fig/matched_delta_gap_six.png}
\caption{Matched pairs: $\Delta$ core gap (twin - control) for $c\equiv 0 \pmod 6$.}
\end{figure}
